...
@section('head_content')
    ...
    <style>
        /*html { height: 100% } body { height: 100%; margin: 0px; padding: 0px; text-align: center; } */
        #container { height: 100% }
        #searchBox { position: absolute; width: 70%; top: 8%; left: 10%; z-index: 10; }
        .BMap_cpyCtrl { display: none!important; }
        #bg-container { left: 0; right: 0; top: 0; bottom: 0; background-color: #000; opacity: 0.5; position: fixed; z-index: 20; visibility: hidden; }
        #album { position: absolute; z-index: 30; width: 900px; left: 50%; margin-left: -500px; margin-top: 100px; visibility: hidden; }
        #imageDiv { display: inline-block; width: 600px; height: 600px; position: relative; }
        #mainImg { min-width: 300px; max-width: 600px; min-height: 330px; max-height: 600px; position: absolute; top: 50%; left: 50%; -ms-transform: translate(-50%, -50%); -moz-transform: translate(-50%, -50%); -o-transform: translate(-50%, -50%); transform: translate(-50%, -50%); }
        #album p { position: absolute; top: -50px; left: 100px; color: #000; }
        #closeBg { width: 50px; height: 50px; position: absolute; right: 75px; top: -25px; opacity: .7; cursor: pointer; }
        #closeBg:hover { opacity: 1; }
        #pre { width: 50px; height: 50px; display: inline-block; position: absolute; top: 275px; left: 50px; opacity: .7; cursor: pointer; }
        #pre:hover { opacity: 1; } #next { width: 50px; height: 50px; display: inline-block; position: absolute; top: 275px; right: 50px; opacity: .7; cursor: pointer; }
        #next:hover { opacity: 1; } #viewT { width: 800px; height: 95px; overflow: hidden; margin-left: 50px; margin-top: 20px; }
        #thumbnail { width: 10000px; height: 95px; padding: 0; text-align: center; margin: 0; clear: both; }
        #thumbnail li { list-style: none; position: relative; float: left; width: 95px; height: 95px; box-sizing: border-box; margin-right: 5px; }
        #thumbnail img { min-width: 50px; max-width: 89px; min-height: 50px; max-height: 89px; position: absolute; top: 50%; left: 50%; -ms-transform: translate(-50%, -50%); -moz-transform: translate(-50%, -50%); -o-transform: translate(-50%, -50%); transform: translate(-50%, -50%); }
        #left { width: 25px; height: 50px; position: absolute; left: 0; bottom: 80px; cursor: pointer; }
        #right { width: 25px; height: 50px; position: absolute; right: 0; bottom: 80px; cursor: pointer; }
        #addImg { width: 200px; height: 40px; font-size: 15px;line-height: 40px; color: #d5d4d4; background-color:#4a4a4a; cursor: pointer; margin-left: 40%; margin-top: 20px; }
        #addImg:hover { background-color: #2c2b2b; } #on { border: 3px solid #252524; transform: scale(0.9, 0.9); }
        .BMap_Marker { display: none; } span[unselectable="on"] { display: none; }
    </style>
@endsection
        ...
        for (let i = 0; i < count; i++) {
            ...
            req.onsuccess = function(e){
                ...
                var html = "<div class='overLay num"+reqObj.id+"' style='position: absolute;z-index: 100;'>"
                    +"<img src='images/close.png' class='close' style='position:absolute;top: -5px;right: -5px;width:20px;height:20px;display:none'>"
                    +"<img class='image1' style='" + wOrH + ": 50px;border:4px solid #fff;box-shadow:1px 1px 1px #666' src='" + reqObj.url0 + "' />"
                    +"<div style='position: relative;margin-top:-5px;margin-left:40%'><span style='display: block; width:0; height:0; border-width:16px 6px 0; border-style:solid; border-color:#666 transparent transparent;/*灰 透明 透明 */ position:relative;'>"
                    +"<em style=' display:block; width:0; height:0; border-width:15px 5px 0; border-style:solid; border-color:#fff transparent transparent;/*黄 透明 透明 */ position:absolute; top:-16px; left:-5px;'></em></span></div>"
                    + "</div>";
